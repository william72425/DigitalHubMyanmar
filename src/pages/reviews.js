      ...
      <div className={`min-h-screen transition-all duration-300 relative overflow-x-hidden ${
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 md:py-16 relative z-10">
          ...
          >
            <Link href="/">
              <motion.button 
                className={`flex items-center gap-2 font-medium mb-8 transition-all ${
                  isDarkMode
                ...
                >
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all border-2 ${
                      isDarkMode
                        ? 'border-white/10 text-white hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed'
