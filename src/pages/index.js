    ...
    return (
      <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <button onClick={fetchData} className="mt-4 bg-[#FF6B35] text-white px-4 py-2 rounded-lg">
            Retry
          </button>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          {filteredServices.length > 0 ? (
                ...
                {filteredServices.map((service, idx) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      {service.logo_url ? (
                        <img src={service.logo_url} className="w-12 h-12 rounded-full object-cover" alt={service.name} />
                      ) : (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-sm mt-2">Total services in DB: {services.length}</p>
            </div>
          )}
        </div>
      </div>
